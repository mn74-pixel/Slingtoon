import { DEFAULT_LEVEL, WORLD } from "./levels.js?v=0.22.1";
import { FIXED_STEP, clamp, contains, magnitude, stepPhysics } from "./physics.js?v=0.22.1";
export { DEFAULT_LEVEL, LEVELS, WORLD, getLevel } from "./levels.js?v=0.22.1";
