import { DEFAULT_LEVEL, WORLD } from "./levels.js?v=0.25.0";
import { FIXED_STEP, clamp, contains, magnitude, stepPhysics } from "./physics.js?v=0.25.0";
export { DEFAULT_LEVEL, LEVELS, WORLD, getLevel } from "./levels.js?v=0.25.0";
