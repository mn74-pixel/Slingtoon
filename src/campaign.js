...
import { CAMPAIGN_ROUTES } from "./campaign-routes.js?v=0.32.0";
import { PROP_CLEARANCE, clearanceBetween, goalParts, propParts, spansVertically } from "./prop-art.js?v=0.32.0";
