...
import { CAMPAIGN_ROUTES } from "./campaign-routes.js?v=0.35.0";
import { PROP_CLEARANCE, clearanceBetween, goalParts, propParts, spansVertically } from "./prop-art.js?v=0.35.0";
