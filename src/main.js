import { GameModel, GameMode, GamePhase, LEVELS, modifierName } from "./game.js?v=0.31.0";
import { GameRenderer } from "./render.js?v=0.31.0";
import { GameAudio } from "./audio.js?v=0.31.0";
import { FaceStudio } from "./face-studio.js?v=0.31.0";
import { CHARACTER_UNLOCKS, PROGRESS_KEY, TOKEN_SCORE_STEP, characterLock, countMastered, countStars, isMastered, readProgress, hintOffer, purchaseHint, recordStreak, rewardSuccess, medalText } from "./progress.js?v=0.31.0";
import { STREAK_MAX_SHOTS, STREAK_MIN_POOL, canStartStreak, clearStreakMission, createStreakRun, drawStreakMission, spendStreakShot, streakSummary } from "./streak.js?v=0.31.0";
import { CHAPTERS } from "./levels.js?v=0.31.0";
...
let lastReward = null;
const FULLSCREEN_TIP_KEY = "slingtoon-fullscreen-tip-0.31.0";
...
window.addEventListener("load", () => {
  if ("serviceWorker" in navigator && (location.protocol === "https:" || location.hostname === "localhost")) {
    navigator.serviceWorker.register("./sw.js?v=0.31.0").catch(() => {});
  }
