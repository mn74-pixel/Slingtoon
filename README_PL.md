# SlingToon Web 0.5 — GitHub Pages / PWA
...
- Przycisk `☺` wczytuje zdjęcie wyłącznie lokalnie; plik nie jest wysyłany.
...
Testy sprawdzają Quick Sling, One Move, identyczny replay What If, realne działanie czterech modyfikatorów, różnice między osobowościami oraz serwowanie gotowego artefaktu GitHub Pages.
